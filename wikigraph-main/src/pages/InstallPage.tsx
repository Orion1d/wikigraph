...
const InstallPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Install WikiGraph | Add to Home Screen</title>
        <meta name="description" content="Install WikiGraph as a Progressive Web App for faster access and offline support on iOS and Android." />
        <link rel="canonical" href="https://wikigraph.app/install" />
        <meta property="og:title" content="Install WikiGraph | Add to Home Screen" />
        <meta property="og:description" content="Install WikiGraph as a Progressive Web App for faster access and offline support on iOS and Android." />
        <meta property="og:url" content="https://wikigraph.app/install" />
        <meta name="twitter:title" content="Install WikiGraph | Add to Home Screen" />
        <meta name="twitter:description" content="Install WikiGraph on your device and use it with an app-like experience." />
      </Helmet>
      ...
      {/* Content */}
      <main className="flex-1 flex flex-col items-center justify-center p-6 text-center pb-[max(1.5rem,env(safe-area-inset-bottom,0px))]">
        <img src={WIKIGRAPH_LOGO} alt="WikiGraph" className="w-20 h-20 mb-6" />
